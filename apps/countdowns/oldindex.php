...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'add' || $action === 'edit') {
        $fields = [
            ...
            'pto_needed'   => trim($_POST['pto_needed']   ?? '') ?: null,
            'pto_approved' => trim($_POST['pto_approved'] ?? '') ?: null,
            'ticket_type'  => trim($_POST['ticket_type']  ?? '') ?: null,
            'seated'       => trim($_POST['seated']       ?? '') ?: null,
        ];
...
<div class="overlay" id="viewOverlay" onclick="closeIfOutside(event,'viewOverlay')">
  <div class="view-modal">
    ...
    <div class="view-body">
      ...
      <div class="view-block">
        <div class="view-row">
          <span class="view-row-icon">🎟️</span>
          <div class="view-row-content">
            <div class="view-row-label">Ticket Type</div>
            <div class="view-row-value" id="vTicketType">—</div>
          </div>
        </div>
        <div class="view-row">
          <span class="view-row-icon">🪑</span>
          <div class="view-row-content">
            <div class="view-row-label">Sitting Down</div>
            <div class="view-row-value" id="vSeated">—</div>
          </div>
        </div>
        <div class="view-row">
          <span class="view-row-icon">🏖️</span>
          <div class="view-row-content">
            <div class="view-row-label">PTO Needed</div>
            <div class="view-row-value" id="vPtoNeeded">—</div>
          </div>
        </div>
        <div class="view-row">
          <span class="view-row-icon">✅</span>
          <div class="view-row-content">
            <div class="view-row-label">PTO Approved</div>
...
<div class="overlay" id="eventOverlay" onclick="closeIfOutside(event,'eventOverlay')">
  <div class="modal">
    ...
    <div class="modal-body">
      ...
      <div class="dt-row">
        <div class="field-box">
          <label class="field-box-label" for="fTicketType">🎟️ Ticket Type</label>
          <div class="menu-wrap" style="margin-top:2px;">
            <select class="field-box-input" id="fTicketType"
                    style="padding:0; font-size:0.9rem; font-weight:600; cursor:pointer; color-scheme:dark;">
              <option value="">None</option>
        ...
        <div class="field-box">
          <label class="field-box-label" for="fSeated">🪑 Sitting Down</label>
          <div class="menu-wrap" style="margin-top:2px;">
            <select class="field-box-input" id="fSeated"
                    style="padding:0; font-size:0.9rem; font-weight:600; cursor:pointer; color-scheme:dark;">
              <option value="">—</option>
      ...
      <div class="dt-row">
        <div class="field-box">
          <label class="field-box-label" for="fPtoNeeded">🏖️ PTO Needed</label>
          <div class="menu-wrap" style="margin-top:2px;">
            <select class="field-box-input" id="fPtoNeeded"
                    style="padding:0; font-size:0.9rem; font-weight:600; cursor:pointer; color-scheme:dark;">
              <option value="">—</option>
              <option value="Yes">Yes</option>
              <option value="No">No</option>
        ...
        <div class="field-box">
          <label class="field-box-label" for="fPtoApproved">✅ PTO Approved</label>
          <div class="menu-wrap" style="margin-top:2px;">
            <select class="field-box-input" id="fPtoApproved"
                    style="padding:0; font-size:0.9rem; font-weight:600; cursor:pointer; color-scheme:dark;">
              <option value="">—</option>
              <option value="Yes">Yes</option>
              <option value="No">No</option>
...
function openViewModal(item) {
  ...
  setViewField('vPtoNeeded',   item.pto_needed);
  setViewField('vPtoApproved', item.pto_approved);
...
function openEditModal(item) {
  ...
  document.getElementById('fTicketType').value  = item.ticket_type  || '';
  document.getElementById('fSeated').value      = item.seated       || '';
  document.getElementById('fPtoNeeded').value   = item.pto_needed   || '';
  document.getElementById('fPtoApproved').value = item.pto_approved || '';
  updateCharCount();
...
function resetForm() {
  ...
  document.getElementById('fSeated').value            = '';
  document.getElementById('fPtoNeeded').value         = '';
  document.getElementById('fPtoApproved').value       = '';
...
function submitEvent() {
  ...
  fd.append('ticket_type',  document.getElementById('fTicketType').value);
  fd.append('seated',       document.getElementById('fSeated').value);
  fd.append('pto_needed',   document.getElementById('fPtoNeeded').value);
  fd.append('pto_approved', document.getElementById('fPtoApproved').value);
